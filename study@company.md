...
> (1)研修会（岡村さん･･･プロマネ、長尾さん･･･サーバー、新田･･･CartoDB　等）やセミナーなどに参加した内容を発表してもらう。
> (2)ものづくり補助金の内容を発表してもらう。
> (3)プログラム勉強会の状況をはなしてもらう。
> (4)ビスケットを使ってプログラミング勉強をする。 http://www.digitalpocket.org/viscuit/
> (5)scratchを使ってビジュアルプログラミングをやってみる。 https://scratch.mit.edu
> (6)アイデアソンをやった結果をビジュアル言語を使い、ハッカソンまで行う。
